...
const Gallery = () => {
  return (
    <>
      <section className="gallery-section mt-10 md:mt-40 bg-[url('assets/bg_gallery.png')] bg-cover bg-center bg-no-repeat">
        <div className="w-11/12 md:w-10/12 mx-auto py-11 md:py-20">
          <Header
          ...
          />
          <div className="gallery-list mt-4 md:mt-10">
